...
namespace Dominio.EntidadesDelDominio.Entidades
{
    public class Arrendatario : Usuario
    {
       ...
       public string TipoArrendador { get; set; }
        ...
        public Arrendatario(string cedula, string nombre, string apellido, DateTime? fecha, string nacionalidad, char genero) : base(cedula, nombre, apellido, fecha, nacionalidad, genero)
        {
        }
    }
}
